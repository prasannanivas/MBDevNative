...
const CallButtonIcon = ({ width = 43, height = 43, inverted = false, ...props }) => {
  const bgColor = inverted ? '#FFFFFF' : (props.bgColor || "#377473");
  const strokeColor = inverted ? '#F0913A' : '#FDFDFD';
  const strokeWidth = inverted ? 1 : 0;
